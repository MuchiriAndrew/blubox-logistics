...
function Navbar() {
  return (
    <>
    <div style={{ width: '100%', height: '100%', justifyContent: 'center', alignItems: 'center', gap: '191px', display: 'inline-flex' }}>
      ...
      <div style={{ justifyContent: 'flex-start', alignItems: 'center', gap: '12px', display: 'flex' }}>
        <div style={{ width: '70px', height: '70px', justifyContent: 'center', alignItems: 'center', display: 'flex' }}>
          <div style={{ width: '70px', height: '70px', position: 'relative' }}>
            {/* <div style={{ width: '50.91px', height: '30.37px', left: '9.55px', top: '5.84px', position: 'absolute', background: '#7990FB' }}></div>
            <div style={{ width: '26.83px', height: '38.09px', left: '6.51px', top: '26.06px', position: 'absolute', background: '#7990FB' }}></div>
            <div style={{ width: '26.83px', height: '38.09px', left: '36.66px', top: '26.06px', position: 'absolute', background: '#7990FB' }}></div> */}
        ...
        <div style={{ textAlign: 'center', color: 'black', fontSize: '24px', fontFamily: 'Quicksand', fontWeight: 700, wordWrap: 'break-word' }}>BluBox Logistics</div>
      </div>

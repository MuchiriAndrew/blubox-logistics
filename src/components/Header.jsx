...
function Header() {
  return (
    <>
    <div style={{width:"1782px", maxWidth:"1440px",height:'898px', position: 'absolute', top:"150px", left:"0", display:"inline-flex", justifyContent:"center", alignItems:"center" ,overflow:"hidden"}}>
